...
const character = {
  ...
  updateOne: function(req, res) {
    ...
    db.Character.update({ [column]: encodedContent }, { where: { id } }).then(
      response => {
  ...
  updateAll: function(req, res) {
    ...
    db.Character.update(updatedContent, { where: { id } }).then(
      response => {
        res.send("updated one character (all columns)");
        console.log("updated one character (all columns)");
      }
    )
  },
  ...
  addOne: function(req, res) {
    ...
    db.Character.create(character).then(response => {
  ...
  deleteOne: function(req, res) {
    ...
    db.Character.destroy({ where: { id } }).then(response => {
